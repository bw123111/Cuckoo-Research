#### Veg and LiDAR comparison Preliminary###################
...
# Read in data
lidar_height <- read.csv("./Data/Spatial_Data/Comparison_LiDAR_Veg/Raw_Data_fromArcPro/MISO_FergBlaine_AvgHeight2.csv") %>% clean_names() #%>% select(point_id, max_height_m)
...
lidar_cancov <-  read.csv("./Data/Spatial_Data/Comparison_LiDAR_Veg/Raw_Data_fromArcPro/MISO_FergBlaine_CanopyCover2.csv") %>% clean_names()
