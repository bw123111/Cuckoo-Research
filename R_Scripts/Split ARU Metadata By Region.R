...
# Read in cleaned data
all_metadata <- read.csv("./Data/Metadata/Outputs/2023_ARURetrieval_Metadata_Cleaned9-12.csv")
...
# export the upper missouri data for Bella to test the audiomoths
write.csv(upper_miso, "./Data/Metadata/Outputs/2023_ARURetrieval_Metadata_UpperMiso_9-14.csv", row.names = FALSE)
