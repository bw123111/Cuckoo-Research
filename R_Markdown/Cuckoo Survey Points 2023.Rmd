...
#plot(lcov)
# from Mark's script
# I'm trying to make a map like this but in the viewer mode
# try in plot first
tmap_mode("view")
# put landcover into for the habitat_stack - do lcov$Class
map2 <- tm_shape(lcov_mush, raster.warp=FALSE) +  tm_raster()
#Error: Unable to transform stars

# plot for full land cover
map <- tm_shape(lcov, raster.warp=FALSE) +  tm_raster()
map + tm_shape(locs_sf_file) + tm_dots(col = "organization", palette = "Dark2", n = 6)
