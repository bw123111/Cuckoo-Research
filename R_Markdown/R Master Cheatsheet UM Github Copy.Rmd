...
## Method 2: mapview
## good for quickly visualizing things
mapview(locs)
...
# If you import a .tif file from an arcGIS file that has more .tif.aux files and things like that you only need the .tif to visualize it and work with
